...
const pages = {
  en: {
    ...
    updates: {
      ...
      html: `<section><h2>27 August 2026</h2><ul><li>Added Japanese, English and Chinese interfaces.</li><li>Added current-location display.</li><li>Added 672 bicycle-parking facilities from official datasets published by 22 municipalities.</li><li>Made language choices more visible and added map-location-aware correction reports.</li><li>Removed the terrain layer after initial review.</li></ul></section><section><h2>26 August 2026</h2><ul><li>Added public hosting, security settings and a commercial map-tile provider.</li><li>Added public pages covering methodology, privacy and terms.</li><li>Organized Tokyo-wide area shortcuts and official references.</li></ul></section><section><h2>25 August 2026</h2><ul><li>Imported Tokyo-wide cycling-related OpenStreetMap data.</li><li>Omitted short bicycle-crossing strokes.</li><li>Resolved overlaps between mixed-traffic and more comfortable classes.</li></ul></section><p class="updated">Data is refreshed according to source availability and review capacity.</p>`
    },
    contact: {
